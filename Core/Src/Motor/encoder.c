...
int32_t encoder_M1_count_last;
int32_t encoder_M1_count;

float M1_speed;

int32_t encoder_M1_count_per;
...
Status Get_M1_SPD()
{
	...
	else
	{
		...
		M1_speed = (float)encoder_M1_count_per*10.0/64/50;//50 for gearbox(120rpm),64 pulse per 
